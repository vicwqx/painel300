...
const ICONS: Record<string, ComponentType<{ size?: number; strokeWidth?: number }>> = {
  ...
  "/dashboard/sdr": Phone,
  "/dashboard/sdr/lancamento": ClipboardList,
  "/dashboard/sdr/lancamentos": History,
  "/dashboard/gerente-sdr": Phone,
  "/dashboard/em-breve": Handshake,
  "/dashboard/closer": Handshake,
  "/dashboard/closer/lancamento": ClipboardList,
  "/dashboard/closer/lancamentos": History,
  "/dashboard/gerente-closer": Users,
  "/dashboard/gerente": LayoutDashboard,
  "/dashboard/gerente/sdr": Phone,
  "/dashboard/gerente/closer": Handshake,
  "/dashboard/gerente/relatorios": History,
  "/dashboard/gerente/equipe": Users,
